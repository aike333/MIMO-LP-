...
cmd_opt = argparse.ArgumentParser(description='Argparser for MIMO-LP')
cmd_opt.add_argument('-mode', default='cpu', help='cpu/gpu')
cmd_opt.add_argument('-gm', default='MIMO-LP', help='model to use')
...
class GNNGraph(object):
    def __init__(self, g, label, node_tags=None, node_features=None,subgraph2list =None,len_out = None,subgraph_RPE=None):
        '''
            g: a networkx graph
            label: an integer graph label
            node_tags: subgraph features
        ...
        self.subgraph2list = subgraph2list
        self.len_out = len_out
        self.subgraph_RPE = subgraph_RPE
        #print( "nx graph:",  g.nodes())
